...
<head>
    ...
    <title></title>
    <meta name="description" content="Tinymarket">
...
<nav class="shadow navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid" style="margin: 0 240px;">
        <a class="navbar-brand" href="#">Tinymarket.</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="#">Tentang Tinymarket</a>
                </li>
                <li class="nav-item">
        ...
        <div class="login-btn">
            ...
            <button type="button" class="btn btn-success px-4">Daftar</button>
        </div>
    </div>
</nav>